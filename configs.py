...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/oangelangelangelo")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/oangelangelangelo")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://t.me/oangelangelangelo")
